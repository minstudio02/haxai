...
async function onGameStop(data, server) {
...
module.exports = { onGameTick, onPlayerJoin, onPlayerLeave, onPositionsReset, onGameStart, onGameStop, onPlayerChat, onBotAuthentification };
